                    ...
                    <div className="container">
                        ...
                        <div className="experience__items">
                            <div className="experience__item">
                                <SlideInWhenVisible>
                                    <p className="experience__item-text">
                                        <b>2018</b> - Прошел курсы по веб-дизайну от WDI Design School, подработка на
                                        фрилансе в
                                        качестве дизайнера
                                    </p>
                                </SlideInWhenVisible>
                            ...
                            <div className="experience__item">
                                <SlideInWhenVisible>
                                    <p className="experience__item-text">
                                        <b>2019</b> - Изучил верстку, продолжил подрабатывать на фрилансе, но уже в
                                        качестве
                                        верстальщика
                                    </p>
                                </SlideInWhenVisible>
                            ...
                            <div className="experience__item">
                                <SlideInWhenVisible>
                                    <p className="experience__item-text">
                                        <b>2020</b> (первая половина) - Прошел курсы на платформе Udemy по Javascript,
                                        начал
                                        увлекаться фронтенд
                                        разработкой
                                    </p>
